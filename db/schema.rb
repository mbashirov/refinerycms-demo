...
ActiveRecord::Schema.define(:version => 20110928233713) do
  ...
  add_index "catalog_entries", ["id"], :name => "index_catalog_entries_on_id"
  add_index "catalog_entries", ["lft"], :name => "index_catalog_entries_on_lft"
  add_index "catalog_entries", ["parent_id"], :name => "index_catalog_entries_on_parent_id"
  add_index "catalog_entries", ["rgt"], :name => "index_catalog_entries_on_rgt"

  create_table "catalog_types", :force => true do |t|
    t.string "name"
  end

  create_table "entry_attribute_type_values", :force => true do |t|
    t.integer "entry_attribute_type_id"
    t.string  "value"
  end

  create_table "entry_attribute_types", :force => true do |t|
    t.integer "catalog_type_id"
    t.string  "name"
    t.boolean "active"
  end

  create_table "entry_attributes", :force => true do |t|
    t.integer "catalog_type_id"
  ...
  create_table "images_catalog_entries", :id => false, :force => true do |t|
    t.integer "image_id"
    t.integer "catalog_entry_id"
    t.integer "position"
  end

  add_index "images_catalog_entries", ["image_id", "catalog_entry_id"], :name => "composite_key_index"
